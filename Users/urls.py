...
from . import views
from .views import users_list, clients_list, delete_user, delete_client, mods_list, admins_list, modManipulation, adminStats

urlpatterns = [
    re_path('signup', views.signup),
    re_path('login', views.login),
    path('client/<int:id>', views.client_login),#view to get the info of the currently connected client
    path('mods/delete/<int:id>', views.delete_modnull),
